<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <link rel="stylesheet" type="text/css"
                href="${pageContext.request.contextPath }/resources/app-assets/fonts/simple-line-icons/style.min.css">
            <link rel="stylesheet" type="text/css"
        ...
        <body class="vertical-layout vertical-menu-modern content-left-sidebar chat-application  fixed-navbar"
                        ...
                        <ul class="chat-sidebar-list">
                         ...
                         -->
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <div class="avatar avatar-away m-0 mr-50">
                                                            <img src="${pageContext.request.contextPath}/resources/upload/${cr.filename}${cr.fileExt}"
                                                                alt="avatar">
                                                            <i></i>
                                                        </div>
                                                    </c:otherwise>
                                                ...
                                                <div class="chat-sidebar-name pl-1">
                                                    <h6 class="mb-0">${cr.chatRoomName}</h6><span
                                                        class="text-muted">${cr.lastMsg}</span>
                                ...
                                <h6 class="px-2 pt-2 pb-25 mb-0">CONTACTS<i
                                        class="feather icon-plus float-right cursor-pointer"></i></h6>
                                            ...
                                            <li>
                                                <div class="d-flex align-items-center">
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <div class="avatar avatar-away m-0 mr-50">
                                                                <img src="${pageContext.request.contextPath}/resources/upload/${wm.filename}${wm.fileExt}"
                                                                    alt="avatar">
                                                                <i></i>
                                                            </div>
                                                        </c:otherwise>
                                                    ...
                                                    <div class="chat-sidebar-name pl-1">
                                                        <h6 class="mb-0" id="chatMemberName">${wm.workMemberName}</h6>
                                                        <span class="text-muted">${wm.workMemberPos}</span>
                                                        <input type="hidden" class="workMemberNo"
                                                            value="${wm.workMemberNo}">
                                                    </div>
                                                </div>
                                            </li>
                                        </c:if>
                        ...
                        <div class="content-body">
                            ...
                            <section class="chat-window-wrapper">
                                <div class="chat-start">
                                    <span
                                        class="feather icon-message-square chat-sidebar-toggle chat-start-icon font-large-3 p-3 mb-1"></span>
                                    <h4 class="d-none d-lg-block py-50 text-bold-500">채팅을 시작해보세요!</h4>
                                    <button
                                        class="btn btn-light-primary chat-start-text chat-sidebar-toggle d-block d-lg-none py-50 px-1">대화하기</button>
                                </div>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body chat-container">
                                                <div class="chat-content">
                                                    ...
                                                    <input type="hidden" value="${sessionScope.workMemberName}"
                                                        id="workMemberName">
                                                    <!-- 가짜 데이터 -->
							                ...
							                <i class="feather icon-user cursor-pointer"></i> -->
                                                ...
                                                <div class="col-md-2">
                                                    <button type="button" id="button-send"
                                                        class="btn btn-primary glow send"><i
                                                            class="feather icon-play"></i>전송</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
