  ...
  !(function (t) {
    ...
    var t,
              ...
              'x' !== i.axis &&
                (n.overflowed[0]
                  ? s[0].height() > s[0].parent().height()
                    ? B.call(this)
                    : (V(t, c[0].toString(), { dir: 'y', dur: 0, overwrite: 'none' }), (n.contentReset.y = null))
                  : (B.call(this),
                    'y' === i.axis
                      ? k.call(this)
                      : 'yx' === i.axis &&
                        n.overflowed[1] &&
                        V(t, c[1].toString(), { dir: 'x', dur: 0, overwrite: 'none' }))),
                'y' !== i.axis &&
                  (n.overflowed[1]
                    ? s[1].width() > s[1].parent().width()
                      ? B.call(this)
                      : (V(t, c[1].toString(), { dir: 'x', dur: 0, overwrite: 'none' }), (n.contentReset.x = null))
                    : (B.call(this),
                      'x' === i.axis
                        ? k.call(this)
                        : 'yx' === i.axis &&
                          n.overflowed[0] &&
                          V(t, c[0].toString(), { dir: 'y', dur: 0, overwrite: 'none' }))),
                o &&
                  n &&
                ...
                (c[0] = Y.call(this, c[0], 'y')),
                  ...
                  setTimeout(function () {
                    null !== c[0] &&
                      ...
                      'x' !== r.axis &&
                      i.overflowed[0] &&
                      ((s.dir = 'y'), (s.overwrite = 'all'), V(n, c[0].toString(), s)),
                      null !== c[1] &&
                        'undefined' != typeof c[1] &&
                        'y' !== r.axis &&
                        i.overflowed[1] &&
                        ((s.dir = 'x'), (s.overwrite = 'none'), V(n, c[1].toString(), s));
                  }, s.timeout);
              }
            });
          }
      ...
      O = function (t) {
        var o = t.type,
          a =
            t.target.ownerDocument !== document ? [e(frameElement).offset().top, e(frameElement).offset().left] : null,
          n =
        ...
        function t(t, a) {
          if ((N(o), !A(o, t.target))) {
            ...
            ('y' === u && !n.overflowed[0]) ||
              ...
              t.deltaFactor < 2 && !i.mouseWheel.normalizeDelta && ((h = t.deltaFactor), (d = 17)),
        ...
        r.bind('focusin.' + i, function (o) {
          ...
          a.is(n.advanced.autoScrollOnFocus) &&
            ...
            (t[0]._focusTimeout = setTimeout(function () {
              ...
              'x' === n.axis ||
                i[0] ||
                V(t, e[0].toString(), { dir: 'y', scrollEasing: 'mcsEaseInOut', overwrite: c, dur: s }),
                'y' === n.axis ||
                  i[1] ||
                  V(t, e[1].toString(), { dir: 'x', scrollEasing: 'mcsEaseInOut', overwrite: c, dur: s });
            }, t[0]._focusTimer)));
        });
      },
      P = function () {
      ...
      F = function (t, o, n, i, r) {
        function l(e) {
          ...
          return (
            ...
            V(t, x.toString(), { dir: f.dir[0], scrollEasing: _, dur: a, onComplete: w }),
            e
              ? void (f.dir = !1)
              : (clearTimeout(f.step),
        ...
        if (
          ...
          b[1] < 0 || (0 === b[0] && 0 === b[1]) ? (b = [0, 0]) : b[1] >= S[1] ? (b = [S[0], S[1]]) : (b[0] = -b[0]),
            ...
            (s.tweenRunning || !((0 === w && b[0] >= 0) || (w === S[0] && b[0] <= S[0]))) &&
              Q(h[0], _, Math.round(b[0]), u[0], n.scrollEasing, n.overwrite, {
                onStart: function () {
                  n.callbacks &&
                    n.onStart &&
                    !s.tweenRunning &&
