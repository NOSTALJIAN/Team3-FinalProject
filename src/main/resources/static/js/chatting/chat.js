...
var info = ['Brad Pitt|Bread|profile-80.jpg', 'Seunghoon Oh|Steve|steve.jpg'];
...
function setInfo() {
  ...
  document.getElementById('user-img').src = '/img/chatting/' + friendInfo[2];
}
  ...
  if (user == userInfo[0]) {
    $(
      '<div class="message message-personal">' +
        fileName +
        '&nbsp;&nbsp;<img src="img/chatting/download.png" height="15px" width="15px" onclick="return saveFile(\'' +
        fileName +
        '\')"/></div>'
    )
      .appendTo($('.mCSB_container'))
    ...
    setTimeout(function () {
      ...
      $(
        '<div class="message new"><figure class="avatar"><img src=\'' +
          ...
          "' /></figure>" +
          fileName +
          // '&nbsp;&nbsp;<img src="img/download.png" height="15px" width="15px" onclick="return saveFile(\'' +
          '&nbsp;&nbsp;<img src="img/chatting/download.png" height="15px" width="15px" onclick="return saveFile(\'' +
          fileName +
          '\')"/></div>'
      )
